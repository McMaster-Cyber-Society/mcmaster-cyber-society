      ...
      <div className="min-h-screen py-20 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold mb-6 bg-linear-to-r from-red-400 to-rose-500 bg-clip-text text-transparent">
              Our Team
            </h2>
          ...
          {members.length === 0 || members[0].name === "Position Open" ? (
            <div className="text-center py-20">
              ...
              <a 
                ...
                className="inline-block bg-linear-to-r from-red-800 to-red-600 text-white px-8 py-3 rounded-full font-semibold hover:shadow-lg hover:shadow-red-900/50 transition-all"
              >
                Get in Touch
              </a>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {members.map((member, idx) => (
                <div 
                  key={idx}
                  className="bg-gray-800/50 rounded-2xl p-6 border border-gray-700 hover:border-red-500/50 transition-all group"
                >
                  <div className="w-16 h-16 bg-linear-to-br from-red-800 to-red-600 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
